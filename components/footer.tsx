...
import { PiInstagramLogoFill, PiTwitterLogoFill, PiFacebookLogoFill, PiYoutubeLogoFill, PiLinkedinLogoFill } from "react-icons/pi";
    ...
    >
      ...
      <div className="flex space-x-4 py-4">
        ...
        <Link href="https://twitter.com" target="_blank">
          <PiTwitterLogoFill className="text-2xl text-gray-500 hover:text-black transition-colors" />
        </Link>
      ...
      <div className="flex space-x-4 py-4">
        ...
        <Link href="/log-in" className="hover:underline">Login</Link>
      </div>
      <div className="flex space-x-4 py-4">
        <a href="mailto:brijestdahiya@gmail.com" className="text-gray-500 hover:text-black">
